                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse d-flex justify-content-end" id="navbarNav">
                            {user ? (
                                ...
                                <Stack direction="row" alignItems="center" justifyContent="center" spacing={2} sx={{ paddingBottom: 0 }}>
                                    <Avatar alt="Cindy Baker" src="https://64.media.tumblr.com/6430bbf22c54bd7446a96be8af5ec0a5/94d97124995c74f1-59/s400x600/87501bd52c57ba8b2aad5cd5ac0c722db51923c6.pnj" sx={{ width: 50, height: 50 }} />
