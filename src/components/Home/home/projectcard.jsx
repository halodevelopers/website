                ...
                <div className="row">
                    ...
                    <div className="col-6 m-2">
                        <Link className={clsx(styles.link)} to="/projects/detail">
                            <strong className={clsx(styles.title)}>Brain Health Detection <span className={clsx("d-inline badge m-2", styles.badge)} style={{ backgroundColor: "#0B0B45" }}>Health</span>
                            <span className={clsx("d-inline badge m-2", styles.badge)} style={{ backgroundColor: "#fcb70f" }}>Sopnsor this project</span>
                            </strong>
